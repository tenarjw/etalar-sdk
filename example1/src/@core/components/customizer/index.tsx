      ...
      <Toggler className='customizer-toggler' onClick={() => setOpen(true)}>
       ...
       <Drawer open={open} hideBackdrop anchor='right' variant='persistent'>
        ...
        >
          ...
          <Typography sx={{ color: 'text.secondary' }}>Customize & Preview</Typography>
          <IconButton
          ...
          <CustomizerSpacing className='customizer-body'>
            ...
            <Box sx={{ mb: 4 }}>
              ...
              <RadioGroup
                row
                value={fontSize}
                onChange={e => handleChange('fontSize', (e.target.value as unknown) as Settings['fontSize'])}
                sx={{ '& .MuiFormControlLabel-label': { fontSize: '.875rem', color: 'text.secondary' } }}
              >
                <FormControlLabel value='30' label='30' control={<Radio />} />
                <FormControlLabel value='14' label='14' control={<Radio />} />
              </RadioGroup>
            </Box>

            {/* Mode */}
            <Box sx={{ mb: 4 }}>
              <Typography>Light or Gray</Typography>
              <RadioGroup
                row
                value={mode}
            ...
            {/* Color Picker */}
            <div>
              <Typography sx={{ mb: 2.5 }}>Color</Typography>
              <Box sx={{ display: 'flex' }}>
                <ColorBox
                  onClick={() => handleChange('themeColor', 'primary')}
                  sx={{
                    ml: 0,
                    backgroundColor: 'primary.main', //'#9155FD',
